...
Look again at the top 50 lines of the sorted file by typing:
\begin{lstlisting}
...
\begin{warning}
This workflow requires raw gene count files and these can be generated using a utility called featureCounts. We require alignments files in BAM format and gene annotation in GTF format for this step.
This is a demo command and you DO NOT need to run this for this tutorial.
\begin{steps}
featureCounts -a <annotation.gtf> -t exon -g gene\_id -o <output file name> sample1.bam sample2.bam sample3.bam
\end{steps}
