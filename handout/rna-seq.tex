...
\begin{note}
This workflow requires raw gene count files and these can be generated using a utility called featureCounts as demonstrated above. We are using a pre-computed gene counts data (stored in \texttt{pnas\_expression.txt}) for this data for this exercise.
\end{note}
